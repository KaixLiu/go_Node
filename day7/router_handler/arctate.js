...
exports.addArticteCates = (req, res) => {
    ...
    db.query(sql, [req.body.name, req.body.alias], (err, results) => {
        ...
        if (results.length === 2) return res.cc("该名称与别名都被占用");
        if (results.length === 1 && results[0].name === req.body.name && results[0].alias === req.body.alias) return res.cc("该名称与别名都被占用");
